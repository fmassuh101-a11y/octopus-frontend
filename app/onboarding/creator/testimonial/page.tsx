  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-neutral-950 to-neutral-950">
      ...
      <div className="px-6 py-4">
        ...
        <p className="text-center text-sm text-neutral-500 mt-2">Paso 5 de 8</p>
      </div>
      ...
      <div className="px-6 flex flex-col items-center justify-center flex-1 pb-32">
        ...
        <div className="relative w-full max-w-md">
          ...
          <div className="relative p-8 text-center">
            <div className="w-20 h-20 bg-gradient-to-r from-emerald-500 to-emerald-600 rounded-full flex items-center justify-center mx-auto mb-4 shadow-xl">
      ...
      <div className="fixed bottom-0 left-0 right-0 p-6 bg-neutral-900/90 backdrop-blur-md border-t border-neutral-800">
        <button
          onClick={handleNext}
          className="w-full py-4 rounded-2xl font-bold text-lg transition-all shadow-xl bg-gradient-to-r from-emerald-500 to-emerald-600 text-white hover:from-emerald-500 hover:to-emerald-600 hover:shadow-2xl hover:scale-[1.02]"
        >
          Continuar
        </button>
      </div>
