...
export default function CreatorSocialsPage() {
  ...
  if (checkingSession) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-neutral-950 to-neutral-950 flex items-center justify-center">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-neutral-950 to-neutral-950">
      ...
      <div className="flex items-center justify-between p-4 bg-neutral-900/80 backdrop-blur-sm sticky top-0 z-10">
        <button onClick={() => window.history.back()} className="p-2 hover:bg-neutral-800 rounded-full">
      ...
      <div className="px-6 py-4">
        <div className="flex space-x-1.5">
          {[1,2,3,4,5,6,7,8].map(i => (
            <div key={i} className="h-1.5 bg-gradient-to-r from-emerald-500 to-emerald-600 rounded-full flex-1"></div>
          ))}
        </div>
        <p className="text-center text-sm text-neutral-500 mt-2">Paso 8 de 8 - ¡Último paso!</p>
      </div>

      <div className="px-6 pb-32">
        <h1 className="text-2xl font-bold text-white mb-2 text-center">Foto y Redes Sociales</h1>
        <p className="text-neutral-500 text-center mb-8">Las marcas quieren conocerte mejor</p>
        ...
        <div className="flex justify-center mb-6">
          <div className="relative">
            <div
              ...
              className="w-28 h-28 rounded-full bg-gradient-to-br from-neutral-900 to-slate-200 border-4 border-white shadow-xl flex flex-col items-center justify-center cursor-pointer hover:scale-105 transition-transform relative overflow-hidden"
            >
              {profilePhoto ? (
                ...
                <>
                  ...
                  <div className="w-8 h-8 bg-gradient-to-r from-emerald-500 to-emerald-600 rounded-full flex items-center justify-center absolute -bottom-0 -right-0 shadow-lg border-2 border-white">
          ...
          <input ref={fileInputRef} type="file" accept="image/*" onChange={handlePhotoUpload} className="hidden bg-neutral-900 text-white placeholder-neutral-500" />
        </div>

        <p className="text-center text-sm text-neutral-400 mb-8 font-medium">* Foto de perfil obligatoria</p>

        {/* Social Media Inputs */}
        <div className="space-y-4">
          {/* Instagram */}
          <div className="bg-neutral-900 rounded-2xl border border-neutral-800 p-4 shadow-sm text-white placeholder-neutral-500">
            <div className="flex items-center">
              <div className="w-12 h-12 bg-gradient-to-br from-emerald-500 via-emerald-500 to-slate-500 rounded-xl flex items-center justify-center mr-4">
              ...
              <div className="flex-1">
                <p className="text-xs text-neutral-500 font-medium mb-1">Instagram</p>
                <div className="flex items-center">
                  <span className="text-neutral-500 mr-1">@</span>
                  <input type="text" value={instagram} onChange={(e) => setInstagram(e.target.value)} placeholder="tu_usuario" className="flex-1 text-white font-medium focus:outline-none bg-transparent" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-neutral-900 rounded-2xl border border-neutral-800 p-4 shadow-sm text-white placeholder-neutral-500">
            <div className="flex items-center">
              ...
              <div className="flex-1">
                <p className="text-xs text-neutral-500 font-medium mb-1">TikTok</p>
                <div className="flex items-center">
                  <span className="text-neutral-500 mr-1">@</span>
                  <input type="text" value={tiktok} onChange={(e) => setTiktok(e.target.value)} placeholder="tu_usuario" className="flex-1 text-white font-medium focus:outline-none bg-transparent" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-neutral-900 rounded-2xl border border-neutral-800 p-4 shadow-sm text-white placeholder-neutral-500">
            <div className="flex items-center">
              ...
              <div className="flex-1">
                <p className="text-xs text-neutral-500 font-medium mb-1">YouTube</p>
                <div className="flex items-center">
                  <span className="text-neutral-500 mr-1">@</span>
                  <input type="text" value={youtube} onChange={(e) => setYoutube(e.target.value)} placeholder="tu_canal" className="flex-1 text-white font-medium focus:outline-none bg-transparent" />
                </div>
              </div>
            </div>
          </div>
        ...
        <p className="text-center text-sm text-neutral-500 mt-6">Las redes sociales son opcionales</p>
      </div>
