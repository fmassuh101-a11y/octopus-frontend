  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <div className="px-6 pb-32">
        ...
        <div className="flex justify-center mb-6">
          <div className="relative">
            ...
            {profilePhoto && (
              <button
                onClick={removePhoto}
                className="absolute -top-1 -right-1 w-7 h-7 bg-red-500 rounded-full flex items-center justify-center text-white hover:bg-red-600 shadow-lg border-2 border-white"
              >
        ...
        <p className="text-center text-sm text-slate-600 mb-8 font-medium">
        ...
        <div className="space-y-4">
          <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden shadow-sm hover:shadow-md transition-shadow">
            <div className="flex items-center p-4">
              <div className="w-12 h-12 bg-gradient-to-br from-pink-500 via-purple-500 to-slate-500 rounded-xl flex items-center justify-center mr-4 shadow-md">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center">
                  ...
                  <input
                    ...
                    className="flex-1 text-gray-800 font-medium focus:outline-none bg-transparent"
                  />
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden shadow-sm hover:shadow-md transition-shadow">
            <div className="flex items-center p-4">
              <div className="w-12 h-12 bg-black rounded-xl flex items-center justify-center mr-4 shadow-md">
                <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden shadow-sm hover:shadow-md transition-shadow">
            <div className="flex items-center p-4">
              <div className="w-12 h-12 bg-red-600 rounded-xl flex items-center justify-center mr-4 shadow-md">
                <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
