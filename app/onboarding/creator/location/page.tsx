  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-neutral-950 to-neutral-950">
      ...
      <div className="px-6 py-4">
        ...
        <p className="text-center text-sm text-neutral-500 mt-2">Paso 4 de 8</p>
      </div>
      ...
      <div className="px-6">
        ...
        <div className="relative mb-8">
          <div className="relative">
            <input
              ...
              className="w-full p-4 bg-neutral-900 border border-neutral-800 rounded-2xl text-lg text-white placeholder-neutral-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent pr-12 shadow-sm"
            />
        ...
        {selectedLocation && (
          <div className="bg-neutral-950 border border-neutral-800 rounded-2xl p-4 mb-8 flex items-center space-x-3 text-white placeholder-neutral-500">
            ...
            <span className="text-neutral-200 font-medium">{selectedLocation}</span>
          </div>
        )}
      </div>
