        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-white/80">Rastrea tus aplicaciones a trabajos</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4 mt-6">
            ...
            <div className="bg-white/20 backdrop-blur rounded-xl p-4 text-center">
              ...
              <div className="text-sm text-white/80">Aceptadas</div>
            </div>
            <div className="bg-white/20 backdrop-blur rounded-xl p-4 text-center">
              <div className="text-3xl font-bold">{rejectedCount}</div>
              <div className="text-sm text-white/80">Rechazadas</div>
            </div>
          </div>
        </div>
      </div>
                  ...
                  <div className="flex-1 p-4">
                    ...
                    <div className="flex items-center justify-between mt-4">
                      <div className="flex items-center gap-4">
                        <span className="font-bold text-gray-900">{app.gig?.budget}</span>
                        <span className="text-sm text-gray-400">{getTimeAgo(app.created_at)}</span>
                      </div>
                    ...
                    {app.message && (
                      <div className="mt-3 pt-3 border-t border-gray-100">
                        <p className="text-sm text-gray-500 line-clamp-2">
                          <span className="font-medium text-gray-700">Tu mensaje:</span> {app.message}
                        </p>
                      </div>
                    )}
                  </div>
