      ...
      <div className="bg-white rounded-xl border border-gray-200 p-4 hover:shadow-md transition-shadow">
        ...
        <div className="flex items-start justify-between mb-3">
          ...
          <div className="flex items-center gap-2">
            {creator?.instagram && (
              <a href={`https://instagram.com/${creator.instagram}`} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-pink-500">
            ...
            {tiktok && (
              <a href={`https://tiktok.com/@${tiktok.username}`} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-black">
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {selectedCreator.creator?.tiktokAccounts?.[0] && (
                    <a
                      href={`https://tiktok.com/@${selectedCreator.creator.tiktokAccounts[0].username}`}
                      target="_blank"
