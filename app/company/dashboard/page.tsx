        ...
        <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
          ...
          <div className="pt-4">
            ...
            <div className="mt-2 space-y-1">
              ...
              <Link href="/company/chat" className="flex items-center space-x-3 px-3 py-2 rounded-lg text-neutral-200 hover:bg-neutral-950 transition-colors">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="p-4 pb-20 border-t border-neutral-800">
          ...
          <div className="mb-3 px-3 py-2 bg-gradient-to-r from-neutral-950 to-neutral-900 rounded-lg border border-emerald-500/20">
            <div className="flex items-center justify-between">
              ...
              <Link href="/company/settings?tab=payment" className="text-xs text-emerald-400 hover:text-emerald-300 font-medium">
