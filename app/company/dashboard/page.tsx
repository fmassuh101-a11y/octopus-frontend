          ...
          <div className="absolute right-0 top-0 bottom-0 w-72 bg-white shadow-xl overflow-y-auto">
            ...
            <nav className="p-4 space-y-1">
              ...
              <div className="pt-4">
                ...
                <div className="mt-2 space-y-1">
                  <button
                    onClick={() => { setShowMobileMenu(false); router.push('/company/profile'); }}
                    className="flex items-center space-x-3 px-3 py-3 rounded-lg text-gray-700 hover:bg-gray-50 w-full text-left"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
