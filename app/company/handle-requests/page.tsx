...
import { BarChart3, Briefcase, Lock, Users } from 'lucide-react'
                  ...
                  <div className="mt-4 pt-4 border-t border-neutral-800 space-y-2">
                    ...
                    {request.handles.instagram && (
                      <a
                        ...
                        className="flex items-center gap-3 p-2 bg-neutral-800 rounded-xl hover:bg-neutral-700 transition"
                      >
                        <div className="w-8 h-8 bg-gradient-to-br from-emerald-600 via-emerald-500 to-orange-400 rounded-lg flex items-center justify-center">
