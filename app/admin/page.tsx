...
import { Ban, BarChart3, Briefcase, Building2, Calendar, CheckCircle2, CircleDollarSign, Folder, GraduationCap, Inbox, MessageCircle, Palette, Search, UserPlus, Users, Wallet } from 'lucide-react'
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex gap-1">
            {[
              ...
              { id: 'waitlist', label: 'Lista de espera', icon: UserPlus, href: '/admin/waitlist' },
