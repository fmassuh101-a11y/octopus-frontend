  ...
  return (
    <div className="bg-neutral-900 rounded-2xl p-6 border border-neutral-800 text-white placeholder-neutral-500">
      <div className="flex items-center gap-2 mb-6">
        ...
        <div>
          <h3 className="font-semibold text-white">Mejores Horas para Publicar</h3>
          <p className="text-xs text-neutral-500">Basado en el engagement de tus videos</p>
        </div>
      </div>
      ...
      <div className="overflow-x-auto -mx-2 px-2">
        <div className="min-w-[400px]">
          ...
          <div className="grid grid-cols-8 gap-1 mb-1">
            <div className="text-xs text-neutral-500 text-center"></div>
            {DAYS_OF_WEEK.map((day) => (
              <div key={day} className="text-xs text-neutral-500 text-center font-medium py-1">
                {day}
              </div>
            ))}
          </div>
          ...
          {TIME_SLOTS.map((slot, slotIdx) => (
            <div key={slot} className="grid grid-cols-8 gap-1 mb-1">
              <div className="text-xs text-neutral-500 flex items-center pr-2">
                {slot}
              </div>
      ...
      <div className="flex items-center justify-center gap-4 mt-4 pt-4 border-t border-neutral-800">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-xs text-neutral-500">Bajo</span>
        </div>
        <div className="flex items-center gap-1.5">
          <div className="w-4 h-4 rounded bg-green-400" />
          <span className="text-xs text-neutral-500">Medio</span>
        </div>
        <div className="flex items-center gap-1.5">
      ...
      {bestTimes.length > 0 && (
        <div className="mt-4 p-4 bg-cyan-50 rounded-xl">
          <div className="flex items-start gap-2">
            <svg className="w-5 h-5 text-cyan-700 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
            </svg>
            <div>
              <p className="text-sm font-medium text-emerald-900">Recomendacion</p>
