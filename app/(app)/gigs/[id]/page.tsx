        ...
        <div className="text-center max-w-md mx-auto px-6">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full bg-neutral-800 text-neutral-200 py-3 rounded-xl font-semibold hover:bg-neutral-800 transition-colors"
            >
              Go to Dashboard
            </button>
          </div>
    ...
    <div className="min-h-screen bg-neutral-950">
      ...
      <div className="bg-neutral-900 sticky top-0 z-10 border-b border-neutral-800">
        <div className="px-4 py-4">
          <div className="flex items-center justify-between">
            <button
              onClick={() => router.push('/gigs')}
              className="w-8 h-8 bg-neutral-800 rounded-full flex items-center justify-center"
            >
              <svg className="w-5 h-5 text-neutral-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
              </svg>
            </button>
            <h1 className="text-lg font-semibold text-white">Gig Details</h1>
      ...
      <div className="px-0">
        <div className="bg-neutral-900">
          ...
          <div className="h-48 bg-gradient-to-br from-emerald-500 via-emerald-500 to-red-500 relative overflow-hidden">
            <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-blue-600 via-emerald-600 to-emerald-600">
          ...
          <div className="bg-neutral-900 px-6 py-4 border-b border-neutral-800">
            <h1 className="text-xl font-bold text-white mb-1">{gig.title}</h1>
            <p className="text-neutral-400 mb-3">{getCompanyName(gig)}</p>
        ...
        <div className="bg-neutral-900 px-6 py-6">
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="bg-neutral-950 p-4 rounded-xl">
                <div className="text-sm text-neutral-500 mb-1">Deadline</div>
            ...
            {gig.requirements && (
              <div className="border-t border-neutral-800 pt-6">
                ...
                <p className="text-neutral-200 whitespace-pre-wrap">{gig.requirements}</p>
              </div>
            )}
            ...
            {gig.deliverables && (
              <div className="border-t border-neutral-800 pt-6">
                ...
                <p className="text-neutral-200 whitespace-pre-wrap">{gig.deliverables}</p>
              </div>
            )}
          </div>
        </div>
        ...
        {/* Apply Section */}
        <div className="bg-neutral-900 px-6 py-6 border-t border-neutral-800">
          {!user ? (
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-white">Apply for this gig</h3>
              ...
              <textarea
                ...
                className="w-full p-4 border border-neutral-800 rounded-xl focus:outline-none bg-neutral-900 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-none"
                rows={6}
              />
              <button
                onClick={handleApply}
