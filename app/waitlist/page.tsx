        ...
        <div className="relative mx-auto w-full max-w-lg">
          ...
          {joinedId ? (
            ...
            <div className="rounded-[28px] border border-cyan-400/20 bg-white/[0.07] p-7 shadow-[0_0_60px_-20px_rgba(34,211,238,0.4)] backdrop-blur">
              ...
              {/* Momento de máxima atención: acaba de anotarse y está esperando.
                  Es cuando más probable es que siga las cuentas. */}
              <div className="mt-4 rounded-2xl bg-white/[0.06] p-4">
                <p className="font-semibold">Síguenos para no perderte la apertura</p>
                <p className="mt-1 text-xs leading-relaxed text-white/50">
                  Avisamos primero por acá cuando abramos las puertas.
                </p>
                <div className="mt-3 grid grid-cols-2 gap-2">
                  <a
                    href="https://www.tiktok.com/@app_desde_zero"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center gap-2 rounded-xl bg-white px-3 py-3 text-sm font-bold text-black transition active:scale-95"
                  >
                  ...
                  <a
                    href="https://instagram.com/octapi_app"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center gap-2 rounded-xl bg-white px-3 py-3 text-sm font-bold text-black transition active:scale-95"
                  >
          ...
          {/* redes — la lista de espera es hoy la única página pública, así que
              es el único lugar donde alguien puede encontrar las cuentas */}
          <div className="mt-10 flex items-center justify-center gap-3">
            <a
              href="https://www.tiktok.com/@app_desde_zero"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.06] px-4 py-2.5 text-sm font-semibold text-white/80 transition hover:bg-white/[0.12] hover:text-white"
            >
              <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-5.2 1.74 2.89 2.89 0 012.31-4.64 2.93 2.93 0 01.88.13V9.4a6.84 6.84 0 00-1-.05A6.33 6.33 0 005 20.1a6.34 6.34 0 0010.86-4.43v-7a8.16 8.16 0 004.77 1.52v-3.4a4.85 4.85 0 01-1-.1z" />
              </svg>
          ...
          <p className="mt-6 text-center text-[11px] text-white/30">Octapi — Creadores que monetizan. Marcas que crecen.</p>
        </div>
      </section>
